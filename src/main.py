...
class BattlegroundSimulator:
    ...
    def run_demo_battle(self, enemy_formation=None, use_rl=False, skip_replay=False, fast_mode=False):
        """
        ...
        Args:
            ...
            skip_replay: If True, skip the step-by-step replay and show only the final state
            fast_mode: If True, also skip replay for efficiency
        ...
        if skip_replay or fast_mode:
            print("Skipping replay. Showing only final state.")
            self.visualizer.render_battle_aftermath(battle_history)
        else:
